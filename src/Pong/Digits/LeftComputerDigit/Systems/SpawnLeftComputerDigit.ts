...
export default function SpawnLeftComputerDigit(update: Update) {
    ...
    const player = entities.entityInstances.find(x => x.__identifier == 'NPC_Score_Left_Digit')!;
