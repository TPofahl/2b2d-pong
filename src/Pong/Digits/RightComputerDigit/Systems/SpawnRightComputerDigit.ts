...
export default function SpawnRightComputerDigit(update: Update) {
    ...
    const player = entities.entityInstances.find(x => x.__identifier == 'NPC_Score_Right_Digit')!;
