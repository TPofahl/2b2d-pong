...
export default function SpawnRightPlayerDigit(update: Update) {
    ...
    const player = entities.entityInstances.find(x => x.__identifier == 'Player_Score_Right_Digit')!;
